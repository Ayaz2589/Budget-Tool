...
export function SettingsPage() {
  ...
  const [openItem, setOpenItem] = useState("google-sheets");
  ...
  return (
    <div data-tour-page="settings" className="flex flex-col min-h-0 flex-1 overflow-hidden">
      ...
      <Accordion
        ...
        className="space-y-3 pb-24 md:pb-0 px-4 md:px-0"
        data-tour="settings-page"
      >
        <AccordionItem value="google-sheets" className={accordionItemClass}>
          <AccordionTrigger className={accordionTriggerClass}>
            <div className="flex flex-col items-start gap-0.5">
              <span>{t("settings.googleSheets")}</span>
              <span className="text-xs font-normal text-muted-foreground">{t("settings.googleSheetsDesc")}</span>
            </div>
          </AccordionTrigger>
        ...
        <AccordionItem value="preferences" className={accordionItemClass}>
          <AccordionTrigger className={accordionTriggerClass}>
            <div className="flex flex-col items-start gap-0.5">
              <span>{t("settings.preferencesTitle")}</span>
              <span className="text-xs font-normal text-muted-foreground">{t("settings.preferencesDesc")}</span>
            </div>
          </AccordionTrigger>
          <AccordionContent className="pb-3 pt-0">
        ...
        <AccordionItem value="card-sources" className={accordionItemClass}>
          <AccordionTrigger className={accordionTriggerClass}>
            <div className="flex flex-col items-start gap-0.5">
              <span>{t("settings.cardSources")}</span>
              <span className="text-xs font-normal text-muted-foreground">{t("settings.cardSourcesDesc")}</span>
            </div>
          </AccordionTrigger>
          <AccordionContent className="pb-3 pt-0">
        ...
        <AccordionItem value="expense-categories" className={accordionItemClass}>
          <AccordionTrigger className={accordionTriggerClass}>
            <div className="flex flex-col items-start gap-0.5">
              <span>{t("settings.expenseCategories")}</span>
              <span className="text-xs font-normal text-muted-foreground">{t("settings.expenseCategoriesDesc")}</span>
            </div>
          </AccordionTrigger>
          <AccordionContent className="pb-3 pt-0">
        ...
        <AccordionItem value="income-categories" className={accordionItemClass}>
          <AccordionTrigger className={accordionTriggerClass}>
            <div className="flex flex-col items-start gap-0.5">
              <span>{t("settings.incomeCategories")}</span>
              <span className="text-xs font-normal text-muted-foreground">{t("settings.incomeCategoriesDesc")}</span>
            </div>
          </AccordionTrigger>
          <AccordionContent className="pb-3 pt-0">
        ...
        <AccordionItem value="owners" className={accordionItemClass}>
          <AccordionTrigger className={accordionTriggerClass}>
            <div className="flex flex-col items-start gap-0.5">
              <span>{t("settings.owners")}</span>
              <span className="text-xs font-normal text-muted-foreground">{t("settings.ownersDesc")}</span>
            </div>
          </AccordionTrigger>
          <AccordionContent className="pb-3 pt-0">
            <OwnersCard
        ...
        <AccordionItem value="danger-zone" className={accordionItemClass}>
          <AccordionTrigger className={accordionTriggerClass}>
            <span className="text-destructive">{t("settings.deleteAllData")}</span>
          </AccordionTrigger>
          <AccordionContent className="pb-3 pt-0">
            <Button
              variant="outline"
