...
function countRecurringDeductions(debt: Debt): number {
...
function currentBalance(debt: Debt, payments: DebtPayment[]): number {
      ...
      <Card>
        ...
        <CardContent>
          {debts.length === 0 ? (
            ...
            <div className="space-y-6">
              {debts.map((debt) => {
                const balance = currentBalance(debt, debtPayments);
