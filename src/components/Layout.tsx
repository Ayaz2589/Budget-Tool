...
export function Layout() {
  ...
  const appTourSteps = useMemo<AppTourStep[]>(
    () => [
      { route: "/dashboard", selector: '[data-tour=\"dashboard-header\"]', title: t("appTour.steps.dashboard.title"), description: t("appTour.steps.dashboard.description") },
      { route: "/dashboard", selector: '[data-tour=\"dashboard-kpis\"]', title: t("appTour.steps.dashboardKpis.title"), description: t("appTour.steps.dashboardKpis.description") },
      { route: "/dashboard", selector: '[data-tour=\"dashboard-trends\"]', title: t("appTour.steps.dashboardTrends.title"), description: t("appTour.steps.dashboardTrends.description") },
      { route: "/dashboard", selector: '[data-tour=\"dashboard-pies\"]', title: t("appTour.steps.dashboardPies.title"), description: t("appTour.steps.dashboardPies.description") },
      { route: "/dashboard", selector: '[data-tour=\"dashboard-expense-by-owner\"]', title: t("appTour.steps.dashboardExpenseByOwner.title"), description: t("appTour.steps.dashboardExpenseByOwner.description") },
      { route: "/dashboard", selector: '[data-tour=\"dashboard-debt-snapshot\"]', title: t("appTour.steps.dashboardDebtSnapshot.title"), description: t("appTour.steps.dashboardDebtSnapshot.description") },
      { route: "/dashboard", selector: '[data-tour=\"dashboard-spend-by-source\"]', title: t("appTour.steps.dashboardSpendBySource.title"), description: t("appTour.steps.dashboardSpendBySource.description") },
      { route: "/dashboard", selector: '[data-tour=\"dashboard-owner-transfers\"]', title: t("appTour.steps.dashboardOwnerTransfers.title"), description: t("appTour.steps.dashboardOwnerTransfers.description") },
      { route: "/dashboard", selector: '[data-tour=\"dashboard-recent-activity\"]', title: t("appTour.steps.dashboardRecentActivity.title"), description: t("appTour.steps.dashboardRecentActivity.description") },
      { route: "/dashboard", selector: '[data-tour=\"dashboard-insights\"]', title: t("appTour.steps.dashboardInsights.title"), description: t("appTour.steps.dashboardInsights.description") },
      { route: "/dashboard?tourSheet=dashboard-settings", selector: '[data-tour=\"dashboard-settings-sheet\"]', title: t("appTour.steps.dashboardSettings.title"), description: t("appTour.steps.dashboardSettings.description") },
      { route: "/dashboard/transactions", selector: '[data-tour=\"transactions-table\"]', title: t("appTour.steps.transactions.title"), description: t("appTour.steps.transactions.description") },
      { route: "/dashboard/transactions?tourSheet=transactions-add", selector: '[data-tour=\"transactions-add-sheet\"]', title: t("appTour.steps.transactionsAdd.title"), description: t("appTour.steps.transactionsAdd.description") },
      { route: "/dashboard/transactions?tourSheet=transactions-filters", selector: '[data-tour=\"transactions-filters-sheet\"]', title: t("appTour.steps.transactionsFilters.title"), description: t("appTour.steps.transactionsFilters.description") },
      { route: "/dashboard/income", selector: '[data-tour=\"income-table\"]', title: t("appTour.steps.income.title"), description: t("appTour.steps.income.description") },
      { route: "/dashboard/income?tourSheet=income-add", selector: '[data-tour=\"income-add-sheet\"]', title: t("appTour.steps.incomeAdd.title"), description: t("appTour.steps.incomeAdd.description") },
      { route: "/dashboard/debt", selector: '[data-tour=\"debt-table\"]', title: t("appTour.steps.debt.title"), description: t("appTour.steps.debt.description") },
      { route: "/dashboard/debt?tourSheet=debt-add", selector: '[data-tour=\"debt-add-sheet\"]', title: t("appTour.steps.debtAdd.title"), description: t("appTour.steps.debtAdd.description") },
      { route: "/dashboard/mortgage", selector: '[data-tour=\"mortgage-table\"]', title: t("appTour.steps.mortgage.title"), description: t("appTour.steps.mortgage.description") },
      { route: "/dashboard/mortgage?tourSheet=mortgage-add", selector: '[data-tour=\"mortgage-add-sheet\"]', title: t("appTour.steps.mortgageAdd.title"), description: t("appTour.steps.mortgageAdd.description") },
      { route: "/dashboard/presets", selector: '[data-tour=\"presets-table\"]', title: t("appTour.steps.presets.title"), description: t("appTour.steps.presets.description") },
      { route: "/dashboard/presets?tourSheet=presets-add", selector: '[data-tour=\"presets-add-sheet\"]', title: t("appTour.steps.presetsAdd.title"), description: t("appTour.steps.presetsAdd.description") },
      { route: "/dashboard/import", selector: '[data-tour=\"data-page\"]', title: t("appTour.steps.data.title"), description: t("appTour.steps.data.description") },
      { route: "/dashboard/settings", selector: '[data-tour=\"settings-page\"]', title: t("appTour.steps.settings.title"), description: t("appTour.steps.settings.description") },
    ],
    [t],
  );
